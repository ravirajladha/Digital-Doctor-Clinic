...
<div class="content">
                        ...
                        <div class="call-window">
                                    ...
                                    <div class="user-details me-auto">
                                        <div class="float-start user-img">
                                            <a class="avatar avatar-sm me-2" href="#" title="Julio Hart">
                                                <img src="<?php echo URLROOT; ?>/assets/img/patients/patient1.jpg"
                            ...
                            <div class="call-contents">
                                <div class="call-content-wrap">
                                    <div class="voice-call-avatar">
                                        <img src="<?php echo URLROOT; ?>/assets/img/assistants/doctor-thumb-02.jpg"
                            ...
                            <div class="call-footer">
                                <div class="call-icons">
                                    <ul class="call-items">
                                        <li class="call-item">
                                            <a href="<?php echo URLROOT; ?>/assistants/video_call" title="Enable Video"
                                        ...
                                        <li class="call-item">
                                            <a href="#" title="Add Prescription" data-placement="top"
                                                data-bs-toggle="modal" data-bs-target="#pres_details">
    ...
    text-transform: uppercase;">
                                            <a href="<?php echo URLROOT; ?>/assistants/show_prescription">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input class="form-control" type="text" placeholder="paracetamol"
                                                readonly>
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" placeholder="6" readonly>
                                        </td>
                                        <td width=100px>
                                            <input class="form-control" type="text" placeholder="2 Days" readonly>
                                        </td>
                                        <td>

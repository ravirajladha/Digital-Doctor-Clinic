                        ...
                        <div class="row mt-5">
                            <div class="col-lg-6">
                                <div class="d-flex justify-content-center">
                                    <img src="/assets/img/doctor-login.jpg" width="100%" height="auto" alt=""
                            ...
                            <div class="col-lg-6">
                                <div class="login-right">
                                    ...
                                    <div class="login-right-wrap">
                                        <h2 style="text-align: center; font-weight: 1000;"> Assistant Login</h2>
                                        <!-- Form -->
                                        <form action="/admin_Assistants_login" method="POST">
                                            @csrf

        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="/sub_admins/add_Digitaldrclininc_center" class="btn btn-primary float-end mt-2">Add
                        Clinic</a>
                </div>
            </div>
        </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="actions">
                                                <a class="btn btn-sm bg-info-light"
                                                    href="/sub_admins/ddccenterview/{{ $clinic->id }}">
                                                    <i class="fe fe-eye"></i> View
                                                </a>
                                                <a class="btn btn-sm bg-success-light"
                                                    href="/sub_admins/edit_ddc_center/{{ $clinic->id }}">

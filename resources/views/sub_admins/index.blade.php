...
<div class="page-wrapper" style="margin-left:240px">
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Welcome Sub Admin!</h3>
                    <ul class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6 d-flex">
                ...
                <div class="card card-table flex-fill">
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="{{ route('admin.view_doctor_register', ['id' => $doctor->id]) }}"
                                                        class="avatar avatar-sm me-2"><img
                                                            ...
                                                            src="/{{ $doctor->photo }}" alt="User Image"></a>
                                                    <a
                    ...
                    <div class="text-end mt-3">
                        <a href="/sub_admins/doctors">View All Doctors</a>
                    </div>
                </div>
                <!-- /Recent Orders -->
            ...
            <div class="col-md-6 d-flex">
                ...
                <div class="card  card-table flex-fill">
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="/admins/patient_profile/{{ $patient->id }}"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="/{{ $patient->image }}" alt="User Image"></a>
                                                    <a
                    ...
                    <div class="text-end mt-3">
                        <a href="/sub_admins/patients">View All Patients</a>
                    </div>
                </div>
                <!-- /Feed Activity -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-table">
                                    ...
                                    @foreach ($consultations as $consultation)
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a
                                                        href="#">{{ optional($consultation->assistant)->name ?? '-' }}</a>
                                                </h2>
                                            </td>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a
                                                        href="#">{{ optional($consultation->patient)->name ?? '-' }}</a>
                                                </h2>
                                            </td>
                    ...
                    <div class="text-end mt-3">
                        <a href="/sub_admins/consultations">View All Consultations</a>
                    </div>
                </div>
                <!-- /Recent Orders -->

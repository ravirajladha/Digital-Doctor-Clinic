					...
					@include('inc_admins/navbar')
						<div class="card">
							<div class="card-body">
								...
								<form action="/sub_admins/updatePatientsbyadmin/{{$patient->id}}" method="post" enctype="multipart/form-data">
									@csrf
			...
			<div class="modal-dialog" style="margin-left:30px !important">
				...
				<div class="modal-content" style="width:1200px">
					<div class="modal-header">
						...
						<button type="button" style="font-size:20px" class="close" onclick="Webcam.reset('#my_camera');" data-bs-dismiss="modal">X</button>
					</div>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<br>
									<br />
									<input class="btn btn-primary" type="button" value="save" onClick="saveSnap()" data-bs-dismiss="modal" />
								</div>
								<div class="col-md-12 text-center">
									<br />
									<input class="btn btn-primary" type="button" value="Capture" id="imagechange2" onClick="take_snapshot()" />
								</div>
							</div>
			...
			$(document).ready(function() {
				...
				function updateSubmitButtonState() {
					if ($('#DirectoremailErrorMessage').text() !== '' || $('#DirectorphoneErrorMessage2').text() !== '') {
						...
						$('#start_consultation').attr('href', '/assistants/start_consultation_for_patient/<?php echo $patient_id; ?>');
					}
				}
			});
		</script>

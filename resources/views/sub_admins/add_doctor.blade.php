        ...
        <div class="col-md-10 col-lg-10 col-xl-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/sub_admins/doctorRegisterByAdmin" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email"
                                        placeholder="Enter Email ID" id="email" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="phone" maxlength="10"
                                        placeholder="Enter Phone Number" id="mobile_number" pattern="[0-9]{10}"
                            ...
                            <div class="col-12 col-md-10 col-lg-11">
                                <div class="row form-row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="form-group">
                                            <label>Year of Completion</label>
                                            <input type="text" class="form-control" name="master_completion_year"
                                                placeholder="Enter Year of Completion">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <div class="row form-row">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="experience_hospital_name" placeholder="Enter Hospital Name">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group">

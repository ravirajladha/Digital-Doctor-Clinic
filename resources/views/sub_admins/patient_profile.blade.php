                            ...
                            <div id="pat_profile" class="tab-pane fade show active">
                                ...
                                <div class="card-body">
                                    ...
                                    @foreach ($get_patient_detail as $patient)
                                        ...
                                        <a href="/sub_admins/patients" class="btn btn-info">Back</a>
                                        <!-- /Create  Patient Profile Form -->
                                    @endforeach
                                </div>
                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <div class="table-action">
                                                                        ...
                                                                        <a href="/sub_admins/show_prescription/{{ $prescript->id }}/{{ $patient_id }}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <div class="table-action">
                                                                        ...
                                                                        <a href="/sub_admins/show_invoice/{{ $inv->id }}/{{ $patient_id }}"
                                                                            class="btn btn-sm bg-info-light">
                                                                            <i class="far fa-eye"></i> View
                                                                        </a>
                                                                    </div>

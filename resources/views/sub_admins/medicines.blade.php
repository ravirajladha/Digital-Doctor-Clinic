        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="/sub_admins/add_medicine" class="btn btn-primary float-end mt-2">Add Medicine</a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="myTable" class="datatable table table-hover table-center">
                                <thead>
                                    <tr>
                                        <th>Serial No.</th>
                                        <th>Medicine Name</th>
...
use App\Models\Medicine;
 ...
 foreach ($get_medicines as $tests) {
	...
	?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <form action="/medicine_status/<?php echo $tests->id; ?>/<?php echo $tests->status == 1 ? 0 : 1; ?>"
                                                    method="POST">
                                                    @csrf
                                        ...
                                        <td>
                                            <div class="actions">
                                                <x-button type="view"
                                                url="{{ url('sub_admins/view_medicine/' . $tests->id) }}" />

                                                <a class="btn btn-sm bg-success-light" data-bs-toggle="modal"
                                                    href="#edit_medicine_details_{{ $tests->id }}">
                                                    <i class="fe fe-pencil"></i> Edit
                                                </a>
                                            </div>

                                            <!-- Edit Details Modal -->
                                            <div class="modal fade" id="edit_medicine_details_{{ $tests->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php $spc = Medicine::where('id', $tests->id)->first();

                                                            ?>
                                                            <form action="/sub_admins/update_medicine" method="post"

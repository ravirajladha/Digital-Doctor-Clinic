            ...
            <div class="container py-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/sub_admins/update_news/{{ $datas->id }}" method="post"
                            ...
                            <div class="row form-row">
                                    ...
                                    <div class="form-group">
                                        <div class="change-avatar">
                                            <div class="profile-img">
                                                ...
                                                <img src="/uploads/newsroom/<?php echo $datas->newphoto; ?>"
                                            ...
                                            <div class="upload-img file-upload">
                                                <div class="change-photo-btn">
                                                    ...
                                                    <input type="file" class="upload" id="image-input"
                                                        onchange="readURL(this);" value="<?php echo $datas->newphoto; ?>"
                                                        name="newsphoto">
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $datas->title; ?>" class="form-control"
                                            name="title" maxlength="100" minlength="100" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $datas->id; ?>" class="form-control"
                                            name="id" required>

                                        <input type="text" value="<?php echo $datas->link; ?>" class="form-control"
                                            name="link" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="change-avatar">
                                            <div class="profile-img">
                                                <img src="/uploads/newslogo/<?php echo $datas->newslogo; ?>"
                                                    class="avatar img-circle img-thumbnail" id="blah"
                                                    alt="avatar" style="height:100px;width:100px;">
                                            </div>
                                            <div class="upload-img file-upload">

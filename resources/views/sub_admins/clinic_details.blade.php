...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <!-- /Page Header -->
        @foreach ($get_clinic as $get_clinics)
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <p class="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">Registrations
                                                </p>
                                                <p class="col-sm-10"><?php echo $get_clinics->registrations; ?></p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">Registration
                                                    Year</p>
                                                <p class="col-sm-10"><?php echo $get_clinics->registration_year; ?></p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">Hospital Name
                                                </p>
                                            ...
                                            <div class="row">
                                                <p class="col-sm-2 text-muted text-sm-end mb-0 mb-sm-3">Person phone
                                                    number</p>
                                        ...
                                        <div class="col-md-10 col-lg-6">
                                            <form>
                                                <div class="form-group" style="margin-bottom:40px; ">
                                                    ...
                                                    <img alt="User Image" src="/<?php echo $get_clinics->aadhar_card; ?> "
                                                        height="200px;" width="300px;" style="margin-left:150px;">

                                                </div>
                                                <div class="form-group" style="margin-bottom:40px;">
                                                    <label>Gst</label><br>
                                                    <img alt="User Image" src="/<?php echo $get_clinics->gst; ?> "
                                                        height="200px;" width="
															300px;"
                                                ...
                                                <div class="form-group" style="margin-bottom:40px;">
                                                    ...
                                                    <img alt="User Image" src="/<?php echo $get_clinics->gov_license; ?> "
                                                        height="200px;" width="300px;" style="margin-left:150px;">

                                                </div>
                                                <div class="form-group" style="margin-bottom:40px;">
                                                    <label>Images</label><br>
                                                    <img alt="User Image" src="/<?php echo $get_clinics->img1; ?> "
                                                        height="200px;" width="300px;" style="margin-left:150px;">

                                                </div>
                                                <div class="form-group" style="margin-bottom:40px;">
                                                    <label>Images </label><br>
                                                    <img alt="User Image" src="/<?php echo $get_clinics->img2; ?> "
                                                        height="200px;" width="300px;" style="margin-left:150px;">

...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="col-md-10 col-lg-10 col-xl-12">
			<form action="/sub_admins/create_clinic" method="post" enctype="multipart/form-data">
			@csrf
						...
						<div class="row form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" placeholder="Enter Clinic/Hospital Name" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="email" class="form-control" name="email" id="email" placeholder="Enter Clinic/Hospital Email" required>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="tel" class="form-control" name="phone" id="phone" maxlength="10" pattern="[0-9]{10}" required placeholder="Enter Clinic/Hospital Phone Number" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="website" placeholder="Enter Clinic/Hospital Website">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Contact Person Name</label>
									<input type="text" class="form-control" name="person_name" placeholder="Enter Contact Person Name" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="tel" class="form-control" name="person_phone_number" id="phone" maxlength="10" pattern="[0-9]{10}" required placeholder="Enter Contact Person Phone Number" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>ZIP Code <span style="font-size: 12px" class="small text-muted">(शहर और राज्य जानने के लिए पिनकोड दर्ज करें)</span></label>
					...
					<div class="card-body">
						...
						<div class="registrations-info">
								...
								<div class="col-12 col-md-5">
									<div class="form-group">
										<label>Year</label>
										<input type="text" class="form-control" name="registration_year" placeholder="Enter Year">
									</div>
								</div>
								<div class="col-12 col-md-5">
									<div class="form-group">

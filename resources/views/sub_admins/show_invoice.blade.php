		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="">Patient Invoice</a></li>
						...
						<div class="card">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="biller-info">
											<h4 class="d-block">Invoic No :{{$invoice->id}}</h4>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="biller-info">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="biller-info">
											<span class="d-block text-sm text-muted"><strong>{{$detailsof->fname}} {{$detailsof->lname}}</strong></span>
											<span class="d-block text-sm text-muted"><strong>Patient ID:</strong>{{$detailsof->id}}</span>

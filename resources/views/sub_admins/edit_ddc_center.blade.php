                        ...
                        <div class="row form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$ddccenter->name}}" name="name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" value="{{$ddccenter->email}}" name="email" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Clinic/Hospital Phone Number</label>
                                    <input type="tel" class="form-control" value="{{$ddccenter->phone}}" name="phone" maxlength="10" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <select name="representatives_name" id="representativesName" class="form-control" >
                                <option value="{{$ddccenter->representatives_name}}">{{$ddccenter->representatives_name}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="representatives_phone" value="{{$ddccenter->representatives_phone}}" id="representativesPhone" readonly >
                                    <input type="tel" class="form-control" name="representatives_id" id="representatives_id" value="{{$ddccenter->representatives_id}}" hidden>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> Street</label>
                                    <input type="text" class="form-control" value="{{$ddccenter->address}}" name="address">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> City</label>
                                    <input type="text" id="city" class="form-control" value="{{$ddccenter->city}}" name="city">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zip Code</label>
                                    <input type="text" class="form-control" id="pincode" value="{{$ddccenter->zipcode}}" name="zipcode">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>State</label>
                                    <input type="text" class="form-control" id="state" value="{{$ddccenter->state}}" name="state">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Country</label>
                                    <input type="text" class="form-control" id="country" value="{{$ddccenter->country}}" name="country">
                                </div>
                            </div>
...
$(document).ready(function () {
    $('#assitnaceDetails').on('change', function () {
        ...
        $.ajax({
            ...
            method: 'GET',
            data: { 'assistance_name': selectedName },
            success: function (data) {
                console.log(data)

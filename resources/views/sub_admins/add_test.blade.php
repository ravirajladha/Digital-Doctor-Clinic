@include('inc_subadmins/header')
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                    ...
                    <form action="/sub_admins/create_test_admin" method="post" enctype="multipart/form-data">
						@csrf
							<!-- test Info -->
							<div class="card">
								<div class="card-body">
									...
									<div class="row form-row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="hidden" name="rexkod_digitaldrclinic_sub_admin_id" value="{{session('rexkod_digitaldrclinic_sub_admin_id')}}">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="Enter Test Description" name="description">
											</div>
										</div>

                                ...
                                <div class="col-lg-6">
                                    <div class="login-right">
                                        <div class="login-right-wrap">
                                            <h2 style="text-align: center; font-weight: 1000;">Sub Admin Login</h2>
								<!-- Form -->
								<form action="/sub_admins/sub_admin_login" method="POST">
								@csrf
									...
									<div class="form-group">
										<button class="btn btn-rounded w-100 " type="submit" style="background-image: linear-gradient(to right, #00ccff, #ff2994); border: none;">Login</button>
									</div>
								</form>
								<!-- /Form -->
							<div class="form-group">

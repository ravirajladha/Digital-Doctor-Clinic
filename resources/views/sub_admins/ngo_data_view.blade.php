                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>शहर/ गांव <span>*</span></label>
                                        <input type="text" readonly name="cpy_city" class="form-control"
                                            value="<?php echo $getData->cpy_city; ?>">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>राज्य <span>*</span></label>
                                        <input type="text" readonly name="cpy_state" class="form-control"
                                            value="<?php echo $getData->cpy_state; ?>">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>पिन कोड <span>*</span></label>
                                        <input type="text" readonly name="cpy_pincode" class="form-control"
                                            value="<?php echo $getData->cpy_pincode; ?>">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <label>संपूर्ण पता। <span>*</span></label>
                                        <textarea type="text" readonly name="company_address" class="form-control"><?php echo $getData->company_address; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="ngo_member" class="form-control"
                                        value="<?php echo $getData->ngo_member; ?>">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label>डायरेक्टर/सर्वोच्च अधिकारी का नाम <span>*</span></label>
                                    <input type="text" readonly name="ngo_director_name" class="form-control"
                                        value="<?php echo $getData->ngo_director_name; ?>">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    <label>मोबाइल No <span>*</span></label>
                                    <input type="number" readonly name="director_phone" class="form-control"
                                        value="<?php echo $getData->director_phone; ?>">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label>ईमेल <span>*</span></label>
                                    <input type="email" readonly name="director_mail" class="form-control"
                                        value="<?php echo $getData->director_mail; ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
...
<div class="col-md-12">
<div class="form-group">
<label for="">NGO जिस क्षेत्र में काम करना चाहती है जनपद (जिला) का नाम चुनें
</label>
...
value="<?php echo $getData->block_name; ?>">
@else
<input type="text" name="block_name" class="form-control" value="Yes">
@endif
</div>
</div>

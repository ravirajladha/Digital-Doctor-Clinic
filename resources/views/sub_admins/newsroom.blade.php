        ...
        <div class="content container-fluid">
            ...
            <div class="container">
                <div class="card">
                    ...
                    <br><br>
                    <form action="/sub_admins/create_news" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row form-row">
                            ...
                            <div class="form-group">
                                <div class="change-avatar">
                                    <div class="profile-img">
                                        <img src="/assets_admin/img/doctors/doctor-thumb-02.jpg" class="avatar img-circle img-thumbnail" id="blah" alt="avatar" style="height:100px;width:100px;">
                                    </div>
                                    <div class="upload-img file-upload">
                                        <div class="change-photo-btn">
                                            <span><i class="fa fa-upload"></i> Upload Photo</span>
                                            <input type="file" class="upload" id="image-input" onchange="readURL(this);" name="newphoto" required>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" maxlength="100" minlength="100" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Description <span class="text-danger">*</span></label>
                                <textarea id="discription" type="text" class="form-control " name="discription"  required maxlength="200" minlength="200"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">

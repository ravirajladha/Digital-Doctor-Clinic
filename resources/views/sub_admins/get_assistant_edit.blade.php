            ...
            <div class="card">
                <div class="card-body">
                    @foreach ($assistant as $assist)
                        <!-- My Profile Form -->
                        <form action="/sub_admins/updateAssistant/{{ $assist->id }}" method="post"
                            ...
                            <div class="row form-row">
                                    ...
                                    <div class="form-group">
                                        <div class="change-avatar">
                                            <div class="profile-img">
                                                <img src="/uploads/assistant/{{ $assist->photo }}" alt="User Image"
                                                    id="changeablephoto">
                                            </div>
                                            <div class="upload-img">
                                                ...
                                                <small class="form-text text-muted">Allowed JPG, GIF, or PNG. Max size
                                                    of 2MB</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" value="{{ $assist->id }}"
                                            name="fname">
                                        <input type="text" class="form-control" value="{{ $assist->fname }}"
                                            name="fname">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $assist->lname }}"
                                            name="lname" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" value="{{ $assist->dob }}"
                                            name="dob">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $assist->mobile }}" class="form-control"
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" class="form-control" value="{{ $assist->street }} "
                                            name="street">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>City</label>
                                        <input type="text" class="form-control" value="{{ $assist->city }}"
                                            name="city" id="city">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>State</label>
                                        <input type="text" class="form-control" value="{{ $assist->state }}"
                                            name="state" id="state">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $assist->zip_code }}"
                                            id="pincode" name="zip_code">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Country</label>
                                        <input type="text" class="form-control" value="{{ $assist->country }}"
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($assist->aadhar_card)
                                            <a href="/uploads/assistant/{{ $assist->aadhar_card }}"
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($assist->pan_card)
                                            <a href="/uploads/assistant/{{ $assist->pan_card }}" target="_blank"><i
                                                    class="fa fa-eye"></i></a>
                                        @endif
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($assist->cancelled_cheque)
                                            <a href="/uploads/assistant/{{ $assist->cancelled_cheque }}"
                                                target="_blank"><i class="fa fa-eye"></i></a>
                                        @endif

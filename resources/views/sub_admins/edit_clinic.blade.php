...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="col-md-10 col-lg-10 col-xl-12">
			...
			<form action="/update_clinic" method="post" enctype="multipart/form-data">
			@csrf
						...
						<div class="row form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" value="{{$clini->name}}">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="email" class="form-control" name="email" value="{{$clini->email}}" id="email" >
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="tel" class="form-control" name="phone" value="{{$clini->phone}}" maxlength="10" >
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" value="{{$clini->website}}" name="website">
								</div>
							</div>
							<!--  -->
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" value="{{$clini->person_name}}" name="person_name">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Contact Person Phone Number</label>
									<input type="number" class="form-control" name="person_phone_number" value="{{$clini->person_phone_number}}" id="phone"  maxlength="10">
								</div>
							</div>
							<!--  -->
							<div class="col-md-6">
								<div class="form-group">
									<label> Street</label>
									<input type="text" class="form-control" value="{{$clini->address}}" name="address">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label> City</label>
									<input type="text" class="form-control" value="{{$clini->city}}" name="city" id="city">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Zip Code</label>
									<input type="text" class="form-control" value="{{$clini->zipcode}}" name="zipcode" id="pincode" >
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>State</label>
									<input type="text" class="form-control" value="{{$clini->state}}" name="state" id="state" >
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Country</label>
									<input type="text" class="form-control" value="{{$clini->country}}" name="country" id="country">
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>GST</label>
                                    @if($clini->gst)
                                     <a href="/{{$clini->gst}} " target="_blank"><i class="fa fa-eye"></i></a>
                                     @endif
							...
							<div class="col-md-6">
								<div class="form-group ">
                                    ...
                                    @if($clini->aadhar_card)
                                     <a href="/{{$clini->aadhar_card}} " target="_blank"><i class="fa fa-eye"></i></a>
                                     @endif
							...
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    @if($clini->gov_license)
                                     <a href="/{{$clini->gov_license}} " target="_blank"><i class="fa fa-eye"></i></a>
                                     @endif
							...
							<div class="col-md-6">
								<div class="form-group ">
                                    ...
                                    @if($clini->img1)
                                     <a href="/{{$clini->img1}} " target="_blank"><i class="fa fa-eye"></i></a>
                                     @endif
							...
							<div class="col-md-6">
                                ...
                                @if($clini->img2)
                                     <a href="/{{$clini->img2}} " target="_blank"><i class="fa fa-eye"></i></a>
                                     @endif
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="registrations-info">
								...
								<div class="col-12 col-md-5">
									<div class="form-group">
										<label>Year</label>
										<input type="text" value="{{$clini->registration_year}}" class="form-control" name="registration_year">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="submit-section submit-btn-bottom float-left">
						<button type="submit" class="btn btn-primary submit-btn" style="border-radius:8px;margin-bottom:50px;">Update</button>
					</div>
				</div>
				<!-- /Registrations -->

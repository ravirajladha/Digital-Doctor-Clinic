                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email" value="{{ $datas->email }}" id="email"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="mobile_number" id="mobile" value="{{ $datas->mobile_number }}"
                                                            class="form-control" readonly>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="post"
                                                class="form-control" value="<?php echo $datas->post; ?>"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-4">
...
<script>
    function goBack() {
        window.location.href = '/admins/representatives';
    }
</script>

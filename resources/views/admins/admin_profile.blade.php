                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <h5 class="card-title d-flex justify-content-between">
                                            ...
                                            <div class="col-auto">
                                                <a class="btn btn-primary" data-bs-toggle="modal"
                                                    href="#edit_personal_details_{{ session('rexkod_digitaldrclinic_admin_id') }}">Edit</a>
                                                </a>
                                            </div>
                                        </h5>
                                        <div class="row">
                                ...
                                <div class="modal fade"
                                    id="edit_personal_details_{{ session('rexkod_digitaldrclinic_admin_id') }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="/admins/admin_personal_details/{{ session('rexkod_digitaldrclinic_admin_id') }}"
                                                    method="post">
                                                    @csrf
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="name"
                                                                    value="{{ session('rexkod_digitaldrclinic_admin_name') }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control"
                                                                    name="email"
                                                                    value="{{ session('rexkod_digitaldrclinic_admin_email') }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="phone"
                                                                    value="{{ session('rexkod_digitaldrclinic_admin_phone') }}">
                                                            </div>
                                                        </div>

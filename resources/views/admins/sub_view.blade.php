		...
		<div class="col-md-10 col-lg-10 col-xl-12">
				<div class="card">
						...
						<div class="row form-row">
							<div class="col-md-6">
								<div class="form-group">
									<label> Name</label>
									<input type="text" class="form-control" name="name" value="{{$sub_admin->name}}" required placeholder="Enter Name" readonly>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="email" class="form-control" name="email" value="{{$sub_admin->email}}" id="email" required placeholder="Enter Email" readonly>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="tel" class="form-control" name="phone" value="{{$sub_admin->phone}}" maxlength="10" pattern="[0-9]{10}" required placeholder="Enter Phone number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" readonly>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label> Street</label>
									<input type="text" class="form-control" name="address" value="{{$sub_admin->address}}" placeholder="Enter Street name" readonly>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label> City</label>
									<input type="text" class="form-control" name="city" value="{{$sub_admin->city}}" id="city" placeholder="Enter City name" readonly>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Zip Code <span class="small text-muted">(शहर और राज्य जानने के लिए पिनकोड दर्ज करें)</span></label>
									<input type="text" class="form-control" name="zipcode" value="{{$sub_admin->zipcode}}" id="pincode" placeholder="Enter Zip code" readonly>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>State</label>
									<input type="text" class="form-control" name="state" value="{{$sub_admin->state}}" id="state" placeholder="Enter State" readonly>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Country</label>
									<input type="text" class="form-control" name="country" value="{{$sub_admin->country}}" id="country" placeholder="Enter Country" readonly>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group ">
                                    ...
                                    <div>
                                        <img src="{{ asset($sub_admin->aadhaar_card) }}" alt=""  width="50%" height="auto">
                                    </div>
                                    @endif
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset($sub_admin->gov_license) }}" alt="" width="50%" height="auto">
                                    </div>
                                    @endif
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group ">
                                    ...
                                    <div>
                                        <img src="{{ asset($sub_admin->profile_img) }}" alt=""  width="50%" height="auto">
                                    </div>
                                    @endif
								</div>
							</div>
					...
					<div class="submit-section submit-btn-bottom float-left">
						<a href="/admins/sub_admin_view" class="btn btn-primary submit-btn" style="border-radius:8px;margin-bottom:50px;">Back</a>
					</div>
				</div>
    </div>
</div>

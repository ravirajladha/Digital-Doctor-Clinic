        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="/admins/add_medicine" class="btn btn-primary float-end mt-2">Add Medicine</a>
                </div>
            </div>
        </div>
	...
	?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <form
                                                action="{{ url('/medicine_status/' . $tests->id . '/' . ($tests->status == 1 ? 0 : 1)) }}"
                                        ...
                                        <td>
                                            <div class="actions">
                                                <x-button type="view"
                                                    url="{{ url('admins/view_medicine/' . $tests->id) }}" />
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            ?>
                                                            <form action="/admins/update_medicine" method="post"

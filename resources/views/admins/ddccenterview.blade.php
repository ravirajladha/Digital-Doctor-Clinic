...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="col-md-10 col-lg-10 col-xl-12">
            <form action="/admins/update_Digitaldrclininc_center/{{$ddccenter->id}}" method="post" enctype="multipart/form-data">
              @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-row">
                            ...
                            <div class="submit-section submit-btn-bottom float-left">
                                <a href="/admins/Digitaldrclininc_center" class="btn btn-primary submit-btn" style="border-radius:8px;margin-bottom:50px;">back</a>
                            </div>
                        </div>
                    </div>
                </div>

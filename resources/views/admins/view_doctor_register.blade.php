                                ...
                                <div class="card-body">
                                                ...
                                                <div class="change-avatar">
                                                    <div class="profile-img">
                                                        ...
                                                        @foreach ($profileimg as $pf)
                                                            ...
                                                            @else
                                                                <img class="avatar-img rounded-circle"
                                                                    src="/uploads/<?php echo $doctor->photo; ?>" alt="User Image">
                                                            @endif
                                                        @break;
                                                    @endforeach
                                                    <?php } else { ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control" name="fname"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control " name="lname"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="gender"
                                                style="background-color: rgb(255, 255, 255)" disabled readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input readonly type="date" class="form-control" name="dob"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="mt-2"><?php if (!empty($doctor->gst)) { ?>
                                                <a href="/<?php echo $doctor->gst; ?>" target="_blank"
                                                    class="btn btn-sm btn-info m-3">View</a> <?php } else {
                                                 } ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group mb-0 mt-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mt-2"><?php if (!empty($doctor->smc_certificate))
                                                    ...
                                                    @foreach ($cert as $ct)
                                                        @if ($ct == 'uploads')
                                                            <a href="/<?php echo $doctor->smc_certificate; ?>" target="_blank"
                                                                class="btn btn-sm btn-info m-3">View</a>
                                                        @else
                    ...
                    <div class="card p-3" style="width:100%;">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea readonly class="form-control mt-2" rows="3" name="about" style="height: 15vh"><?php echo $doctor->about; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /About Me -->
                            ...
                            <div class="row custom_price_cont" id="custom_price_cont" style="display:none">
                                <div class="col-md-4">
                                    <input readonly type="number" class="form-control"
                                        id="custom_price_input" name="pricing" value=""
...
<script>
    function goBack() {
        window.location.href = '/admins/doctors';
    }
</script>

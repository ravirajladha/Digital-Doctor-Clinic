                                            ...
                                            <div class="col-12 col-md-6 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    @if ($doctor->bachelor_document)
                                                        ...
                                                        <!-- <input readonly type="file" class="form-control mt-2" name="bachelor_document"> -->
                                                    @endif
                                                </div>
                                            </div>
                                            <hr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if ($doctor->master_document)
                                                        <div class="mt-2"><a href="/<?php echo $doctor->master_document; ?>"
                                                                ...
                                                                class="btn btn-sm btn-info m-3">View</a></div>
                                                    @endif
                                                    <!-- <input readonly type="file" class="form-control mt-2" name="master_document"> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if ($doctor->experience_letter)
                                                        <div class="mt-2"><a href="/<?php echo $doctor->experience_letter; ?>"
                                                                ...
                                                                class="btn btn-sm btn-info m-3">View</a></div>
                                                    @endif
                                                    <!-- <input readonly type="file" class="form-control mt-2" name="experience_letter"> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>

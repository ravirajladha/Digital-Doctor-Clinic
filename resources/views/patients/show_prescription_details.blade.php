                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="biller-info">
                                    <h4 class="d-block">Prescription No :{{ $invoice->id }}</h4>
                                    <span class="d-block text-sm text-muted">{{ optional($doctorname)->fname }}
                                        {{ optional($doctorname)->lname }}</span>
                                    <span class="d-block text-sm text-muted"> {{ $doctorname->email ?? '' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="biller-info">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="biller-info">
                                    <span
                                        class="d-block text-sm text-muted"><strong>{{ session('rexkod_digitaldrclinic_patients_name') }}</strong></span>
                                    <span class="d-block text-sm text-muted"><strong>Patient
                                            ID:</strong>{{ session('rexkod_digitaldrclinic_patient_id') }}</span>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                @php
                                                    $medicineIds = explode(',', $invoice->medicines);
                                                    $medicines = \App\Models\Medicine::whereIn(
                                                        'id',
                                                        $medicineIds,
                                                    )->get();
                                                @endphp

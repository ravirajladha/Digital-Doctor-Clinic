								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="/uploads/<?php echo $data['get_assistant']->photo;?>" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3><?php echo ucwords($data['get_assistant']->fname." ".$data['get_assistant']->lname);?></h3>

											<div class="patient-details">
												<h5 class="mb-0"> <?php echo $data['get_assistant']->id;?></h5>
											</div>
										</div>
									</div>
								</div>
								<div class="dashboard-widget">
									<nav class="dashboard-menu">
										<ul>
											...
											<li>
												<a href="/assistants/show_medicines ">
											...
											<li>
												<a href="/assistants/profile_settings">

        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                ...
                <div class="card p-3" style="width:100%;">
                    <div class="card-body">
                        <form action="/doctors/update_doctor_register/{{ optional($doctor)->id }}" method="post"
                            enctype="multipart/form-data" class="form-box">
                            @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="upload-img">
                                            <div class="change-photo-btn">
                                                ...
                                                <input type="file" class="upload" name="photo" id="photo-input"
                            ...
                            <div class="col-md-6" style="outline: 1px solid black">
                                <div class="form-group mb-0 mt-3">
                                    ...
                                    <div class="form-group mt-2">
                                        <label style="font-weight: 400;">Number</label>
                                        <input type="Text" name="mci_number" class="form-control"
                                            value="<?php echo $doctor->mci_number; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label style="font-weight: 400;">Certificate</label>
                                        <div class="mt-2"><?php if (!empty($doctor->mci_certificate)) { ?>
                                            ...
                                            <input type="file" name="mci_certificate">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group mb-0 mt-3">
                                    ...
                                    <div
                                        ...
                                        <select name="smc_state" class="form-control mdl-textfield__input"
                                            ...
                                            <option value="Andaman and Nicobar Islands" <?php if ($doctor->smc_state === 'Andaman and Nicobar Islands') {
                                                echo 'selected';
                                            } ?>>
                                    ...
                                    <div class="form-group">
                                        <label style="font-weight: 400;">SMC registration no</label>
                                        <input type="text" name="smc_reg_no" class="form-control"
                                            value="<?php echo $doctor->smc_reg_no; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label style="font-weight: 400;">Certificate</label>
                                        <div class="mt-2"><?php if (!empty($doctor->smc_certificate)) { ?><a href="/<?php echo $doctor->smc_certificate; ?>"
                                                target="_blank" class="btn-sm btn-info m-3">View</a>

                                            <?php } else {
																} ?>
                                            <input type="file" name="smc_certificate">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="country" name="country"
                                    value="<?php echo $doctor->country; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Zip Code</label>
                                <input type="text" id="pincode" class="form-control" name="postal_code"
                                    value="<?php echo $doctor->postal_code; ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card services-card">
                <div class="card-body">
                    ...
                    <!-- /Experience -->
                    <button type="submit" class="btn btn-group-lg btn-success">Update Profile</button>
                    </form>
                </div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-sm-end">
                                ...
                                <div class="billing-info">
                                    <?php
                                    $DDccenter = Assistant::where('auth_id', $get_consultations_with_id->assistant_id)->first();
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="submit-section">
                            <a href="/doctors/my_patients" type="submit" class="btn btn-primary submit-btn">Back
                                to</a>

...
class Admins extends Controller
{
    ...
    public function index()
    {
        ...
        $ngoCount = Ngo_data::count();
        $ddcCenterCount = Digitaldrclininc_center::count();
        $stockCount = DB::table('stocks')->sum('quantity');
    ...
    public function patients()
    {
        ...
        return view('/admins/patients', $data);
    }
    public function consultations()
    {
        ...
        return view('/admins/consultations', $data);
    }
    ...
    public function representatives()
    {
        ...
        return view('/admins/representatives', $data);
    }
    ...
    public function contact_request()
    {
        ...
        return view('/admins/contact_request', $data);
    }
    ...
    public function specialities()
    {
        ...
        return view('admins/specialities', $data);
    }
...
public function admin_login(Request $request)
    {
        ...
        if (is_numeric($username)) {
            $user = Auth::where('phone', $username)->where('type','admin')->first();
        } else {
            $user = Auth::where('email', $username)->where('type','admin')->first();
        }

        if (!$user || !password_verify($password, $user->password)) {
            Session::flash('failed', 'Invalid credentials!');
            return redirect('/admins/login'); // Adjust the route name as needed.
        }

        if ($user->type === "admin") {
            Session::put('rexkod_digitaldrclinic_admin_id', $user->id);
            Session::put('rexkod_digitaldrclinic_admin_name', $user->name);
            Session::put('rexkod_digitaldrclinic_admin_email', $user->email);
            Session::put('rexkod_digitaldrclinic_admin_phone', $user->phone);
            Session::put('rexkod_digitaldrclinic_login_type', $user->type);

            return redirect('/admins/index'); // Adjust the route name as needed.
        } else {
            Session::flash('failed', 'You do not have access!');
            return redirect('admins/login'); // Adjust the route name as needed.
        }
    }
    ...
    {
        $get_ngo_data = Ngo_data::get();
        $data = [
            'get_ngo_data' => $get_ngo_data,
        ];

        return view('admins/ngo_request', $data);
    }
    ...
    public function ngo_data_view($id)
    {
        ...
        return view('admins/ngo_data_view', $data);
    }
    ...
    public function ngoApproval($id, $status)
    {
        ...
        if ($ngoData) {
            ...
            return redirect('/admins/ngo_request');
        } else {
    ...
    public function create_speciality(Request $req)
    {
        ...
        return redirect('admins/specialities');
    }
    ...
    public function change_tests_status($id, $status)
    {
        ...
        return redirect('admins/test')->with('success','Test status updated successfully.');
    }
    ...
    public function medicines()
    {
        ...
        return view('admins/medicines', $data);
    }

    public function add_medicine()
    {

        return view('/admins/add_medicine');
    }
    public function create_medicine_admin(Request $req)
    {
        ...
        $result->company_name = $req->input('company_name');
        $result->description = $req->input('description');
        $result->created_by = session('rexkod_digitaldrclinic_admin_id');
        ...
        $result->save();
        if ($result) {
            return redirect('admins/medicines')->with('success', "Medicine added Successfully");
        } else {
            return redirect('admins/add_medicine')->with('success', "Failed To Add Medicine Try Again");;
        }
    }
    public function medicine_status($id, $status)
    {
        ...
        if ($change_test_status) {
            ...
            return redirect('admins/medicines')->with('success', 'Test status updated successfully');
        } else {
            $_SESSION['error'] = "Test not found.";
            return redirect('admins/medicines');
        }
    }
    ...
    public function clinic_hospital()
    {
        ...
        return view('admins/clinic_hospital', $data);
    }
    ...
    public function change_clinic_status($id, $status)
    {
        ...
        if ($clinic) {
            ...
            return redirect('admins/clinic_hospital')->with('success', "Clinic status updated successfully.");
        } else {
            return redirect('admins/clinic_hospital')->with('success', "Error");
        }

        return redirect('admins/clinic_hospital');
    }

    public function add_clinic()
    {
        return view('/admins/add_clinic');
    }
    ...
    public function create_clinic(Request $req)
    {
        ...
        $createHospitalLogin->password = bcrypt($req->input('password'));
        ...
        if ($clinic) {
            ...
            return redirect('/admins/add_clinic')->with('success', "Clinic Register Successfully");
        } else {

            return redirect('/admins/add_clinic')->with('error', "Failed To Register Try Again");
        }
    }
    ...
    public function Digitaldrclininc_center()
    {
        ...
        return view('/admins/digitaldrclininc_center', $data);
    }
    ...
    public function add_Digitaldrclininc_center()
    {
        ...
        return view('/admins/add_digitaldrclininc_center', $data);
    }
    ...
    public function create_Digitaldrclininc_center(Request $req)
    {
        ...
        if ($result) {
            return  redirect('/admins/add_Digitaldrclininc_center')->with('success', 'DDC Added Successfully');
        } else {
            return redirect('/admins/add_Digitaldrclininc_center')->with('success', 'Failed To Register Try Again');;
        }
    }
    ...
    public function doctors()
    {
        ...
        return view('admins/doctors', $data);
    }
    ...
    public function doctorRegisterByAdmin(Request $req)
    {
        ...
        if ($validatorphone->fails()) {
            return redirect()->back()->with('success', 'Contact Number  Already Present');
        }
        if ($validatormail->fails()) {
            return redirect()->back()->with('success', 'Email  Already Present');
        }
        ...
        if ($doctor) {
            ...
            return redirect('/admins/doctors')->with('success', 'Doctor Added Successfully');
        } else {
            return redirect('/admins/add_doctor')->with('success', 'Error occurred!');
        }
    }
    ...
    public function assistants()
    {
        ...
        return view('admins/assistants', $data);
    }
    ...
    public function change_assistant_status($id, $status)
    {
        ...
        if ($assistant) {
            ...
            $assistant->save();
            return redirect('admins/assistants')->with('success', 'Assistant status updated successfully.');
        } else {
            return redirect('admins/assistants')->with('failed', 'Assistant not found.');
        }
    }
    ...
    public function add_assistant()
    {
        ...
        return view('admins/add_assistant', $data);
    }
    ...
    public function create_assistant(Request $request)
    {
        ...
        if (!$checkauth) {
            ...
            return redirect('/admins/add_assistant')->with('success', 'Already Persent');
        }
        ...
        if ($assistant->save()) {
            return redirect('/admins/add_assistant')->with('success', 'Assistant Registration Successfully');
        } else {
            return redirect('/admins/add_assistant')->with('error', 'Failed To Register. Try Again');
        }
    }
    public function transactions()
    {
        ...
        return view('admins/transactions', $data);
    }


    public function admin_profile()
    {
        $admin = Auth::where('id', session('rexkod_digitaldrclinic_admin_id'))->first();
        $data = [
            'admin' => $admin
        ];
        return view('admins/admin_profile', $data);
    }

    public function invoice_report()
    {
        return view('/admins/invoice_report');
    }
    public function newsroom()
    {
        return view('admins/newsroom');
    }
    ...
    public function create_news(Request $request)
    {
        ...
        if ($newData) {
            ...
            return redirect('admins/newsroomdetails'); // Assuming you have a route named 'newsroom.index' for the newsroom listing.
        }
    }
    ...
    public function newsroomdetails()
    {
        ...
        return view('/admins/newsroomdetails', $data);
    }
    public function edit_newsdetails($id)
    {
        ...
        return view('admins/edit_newsdetails', $data);
    }
    ...
    public function socialmedia()
    {
        ...
        return view('admins/socialmedia', $data);
    }
    ...
    public function updateSocialmedia(Request $req)
    {
        ...
        if ($socialmedia) {
            ...
            return redirect('/admins/socialmedia');
        }
    }
    ...
    public function toUpdateStatus(Request $request)
    {
        ...
        if (!empty($selectedItems)) {
            ...
            return redirect('/admins/newsroomdetails');
        } else {
    ...
    public function view_doctor_register($id)
    {
        ...
        return view('admins/view_doctor_register')->with('doctor', $doctor);
    }

    public function edit_doctor_register($id)
    {
        $doctor = Doctor::find($id);
        return view('admins/edit_doctor_register')->with('doctor', $doctor);
    }
    ...
    public function ngo_data_edit($id)
    {
        ...
        return view('admins/ngo_data_edit', $data);
    }
    ...
    public function view_ngo_certificate_data($id)
    {
        ...
        return view('admins/view_ngo_certificate_data')->with('ngo_data', $ngo_data);
    }
    ...
    public function doctor_approval($id, $status)
    {
        ...
        if ($status) {
            return redirect('/admins/doctors')->with('success', 'Account Activated');
        } else {
            return redirect('/admins/doctors')->with('failed', 'Account Deactivated');
        }
    }
    ...
    public function representative_approval($id, $status)
    {
        ...
        if ($status == 1) {
            $representative->update(['status' => 2]);
        } else {
            $representative->update(['status' => 1]);
        }
        ...
        if ($status == 1) {
            ...
            return redirect()->back()->with('success', 'Documents Verification Done');
        }
    }

    public function get_clinic_by_id($id)
    {
        $get_clinics = Clinics::where('id', $id)->first();

        $data = [
            'get_clinics' => $get_clinics,
        ];

        return view('admins/clinic_details', $data);
    }
    ...
    public function get_assistant_by_id($id)
    {
        ...
        return view('admins/assistant_profile', $data);
    }

    public function add_test()
    {
        return view('/admins/add_test');
    }
    ...
    public function create_test_admin(Request $req)
    {
        ...
        $saveTest->created_by = session('rexkod_digitaldrclinic_admin_id');
        $saveTest->status = 0;

        $saveTest->save();
        if ($saveTest) {
            return redirect('admins/test')->with('success', "Test Added Successfully");
        } else {
            return redirect('admins/add_test')->with('success', 'Failed To Add Test Try Again');
        }
    }
    ...
    public function patient_profile($id)
    {
        ...
        return view('admins.patient_profile', $data);  // Adjust the view path accordingly
    }
    ...
    public function update_doctor_password($id, Request $req){
        $req->validate([
            'password' => 'nullable|min:6|confirmed',
        ]);
        $doctor = Doctor::where('id', $id)->first();
        $find = Auth::find($doctor->auth_id);
        ...
        return redirect()->back()->with('success', 'Doctor Credentials updated Successfully');
    }
    ...
    public function update_news(Request $req, $id)
    {
        ...
        $newsUpdate->save();
        return redirect('admins/newsroomdetails')->with('success', 'News Data Updated Successfully');
    }
    ...
    public function edit_clinic($id)
    {
        ...
        return view('/admins/edit_clinic', $data);
    }
    ...
    public function update_clinic(Request $req)
    {
        ...
        if ($clinic) {
            ...
            return redirect('/admins/clinic_hospital')->with('success', "Clinic updated Successfully");
        } else {

            return redirect('/admins/clinic_hospital')->with('error', "Failed To update Try Again");
        }
    }
    public function delete_clinic($id)
    {
        ...
        $delete->delete();
        return redirect()->back()->with('success', 'Clinic Deleted Successfuly');
    }
    ...
    public function get_assistant_edit($id)
    {
        ...
        return view('/admins/get_assistant_edit', $data);
    }
    ...
    public function  updateAssistant(Request $request, $id)
    {
        ...
        if ($assistant->save()) {
            return redirect('/admins/assistants')->with('success', 'Assistant Updated Successfully');
        } else {
    ...
    public function updatepatients($id)
    {
        ...
        return view('/admins/updatepatients');
    }
    ...
    public function edit_ddc_center($id)
    {
        ...
        return view('/admins/edit_ddc_center', $data);
    }
    public function ddccenterview($id)
    {
        ...
        return view('/admins/ddccenterview', $data);
    }
    ...
    public function update_Digitaldrclininc_center(Request $req, $id)
    {
        ...
        if ($result) {
            return  redirect('/admins/edit_ddc_center/' . $id)->with('success', 'Updated Successfully');
        } else {
            return redirect('/admins/edit_ddc_center/' . $id)->with('success', 'Failed To Register Try Again');;
        }
    }

    public function admin_personal_details($id, Request $req)
    {
        $admin = Auth::find($id);
        $admin->name = $req->name;
    ...
    public function patient_profile_edit($id)
    {
        ...
        return view('/admins/patient_profile_edit', $data);
    }
    ...
    public function camp_request()
    {
        ...
        return view('admins/camp_request', $data);
    }
    ...
    public function vister_details($id)
    {
        ...
        return view('/admins/vister_details', $data);
    }
    ...
    public function show_invoice($id, $patient_id)
    {
        ...
        return view('/admins/show_invoice', $data);
    }
    ...
    public function show_prescription($id, $patient_id)
    {
        ...
        return view('/admins/show_prescription', $data);
    }

    public function sub_admin_reg()
    {
        $pages = Page::get();
        return view('/admins/sub_admin_reg', ['pages' => $pages]);
    }
    ...
    public function create_sub_admins(Request $req)
    {
        ...
        try {
            $createlogin = new Auth();
            $createlogin->name = $req->name;
            $createlogin->email = $req->email;
            $createlogin->phone = $req->phone;
            $createlogin->type = 'sub_admins';
            $createlogin->password = bcrypt($req->input('password'));
            $createlogin->save();

            $auth_id = Auth::where('phone', $req->phone)->first();
            ...
            $subAdmin->city = $req->city;
            $subAdmin->zipcode = $req->zipcode;
            $subAdmin->state = $req->state;
            $subAdmin->country = $req->country;
            $subAdmin->auth_id = $auth_id->id;
            $subAdmin->permissions = implode(',', $req->pages);

            if ($req->hasFile('aadhaar_card')) {
                $file = $req->file('aadhaar_card');
                $unqname = now()->format('Ymd') . now()->timestamp;

                $f_extension = $file->getClientOriginalExtension();
                $f_newfile = '5' . $unqname . '.' . $f_extension;
                $store = $file->move('uploads/sub_admins', $f_newfile);
                $subAdmin->aadhaar_card = $store;
            } else {
                $subAdmin->aadhaar_card = null;
            }
            if ($req->hasFile('gov_license')) {
                $file = $req->file('gov_license');
                ...
                $f_newfile = '5' . $unqname . '.' . $f_extension;
                $store = $file->move('uploads/sub_admins', $f_newfile);
                $subAdmin->gov_license = $store;
            } else {
                $subAdmin->gov_license = null;
            }
            if ($req->hasFile('profile_img')) {
                ...
                $f_newfile = '5' . $unqname . '.' . $f_extension;
                $store = $file->move('uploads/sub_admins', $f_newfile);
                $subAdmin->profile_img = $store;
            } else {
                $subAdmin->profile_img = null;
            }
            $subAdmin->save();
            DB::commit();
    ...
    public function sub_admin_view()
    {
        $subAdmins = Sub_admin::all();
        $data = [
            'subAdmins' => $subAdmins,
        ];
        return view('/admins/sub_admin_view', $data);
    }

    public function subAdmin_approval($id, $status)
    {
        $ddc = Sub_admin::where('auth_id', $id)->first();
        $ddc->status = $status;
        $ddc->save();
        $subadmin = Auth::find($id);
        $subadmin->status = $status;
        $subadmin->save();
        if ($status) {
            return redirect('/admins/sub_admin_view')->with('success', 'Account Activated');
        } else {
            return redirect('/admins/sub_admin_view')->with('failed', 'Account Deactivated');
        }
    }
    public function sub_view($id)
    {
        $sub_admin = Sub_admin::where('id', $id)->first();
        $pages = Page::get();
        return view('admins/sub_view', ['sub_admin' => $sub_admin, 'pages' => $pages]);
    }
    public function sub_admin_edit($id)
    {
        $sub_admin = Sub_admin::where('id', $id)->first();
        $pages = Page::get();
        return view('admins/sub_admin_edit', ['sub_admin' => $sub_admin, 'pages' => $pages]);
    }

    public function updateSubAdmin(Request $req, $id)
    {
        DB::beginTransaction();

        try {
            // Find the sub-admin record by ID
            $subAdmin = Sub_admin::findOrFail($id);

            // Update the Auth record
            $auth = Auth::findOrFail($subAdmin->auth_id);
            $auth->name = $req->name;
            $auth->email = $req->email;
            $auth->phone = $req->phone;
            // You may want to update the password here if necessary
            $auth->save();

            // Update the Sub_admin record
            $subAdmin->name = $req->name;
            $subAdmin->email = $req->email;
            $subAdmin->phone = $req->phone;
            $subAdmin->address = $req->address;
            ...
            if ($req->hasFile('aadhaar_card')) {
                ...
                $subAdmin->aadhaar_card = $subAdmin->aadhaar_card;
            }
            if ($req->hasFile('gov_license')) {
                $file = $req->file('gov_license');
                ...
                $subAdmin->gov_license = $subAdmin->gov_license;
            }
            if ($req->hasFile('profile_img')) {
                $file = $req->file('profile_img');
                ...
                $subAdmin->profile_img = $subAdmin->profile_img;
            }

            $subAdmin->save();
            DB::commit();

            return redirect('/admins/sub_admin_view')->with('success', 'Sub Admin Updated Successfully');
        } catch (\Exception $e) {
            DB::rollback();
            return response()->json(['error' => 'Error: ' . $e->getMessage()]);
        }
    ...
    public function checkEmailExistsddc()
    {
        $email = request('email');
        $existingEmail = Digitaldrclininc_center::where('email', $email)->exists();

        return response()->json(['status' => $existingEmail ? 'exists' : 'not exists']);
    }
    public function checkphoneExistsddc()
    {
        $phone = request('phone');
        $existingphone = Digitaldrclininc_center::where('phone', $phone)->exists();

        return response()->json(['status' => $existingphone ? 'exists' : 'not exists']);
    }

    public function viewContactRequest($id)
    {
        $get_contact_us = Contact_us::find($id);
        return view('admins.view_contact_request', ['get_contact_us' => $get_contact_us]);
    }
    public function viewMedicine($id)
    {
        $medicine = Medicine::find($id);
        return view('admins.view_medicine', ['medicine' => $medicine]);
    }
    public function viewTest($id)
    {
        $test = Test::find($id);
        return view('admins.view_test', ['test' => $test]);
    }
}

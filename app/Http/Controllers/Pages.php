    ...
    public function add_ngo_data(Request $req)
    {
        ...
        try {
            ...
            if ($req->hasFile('ngo_certificate_file')) {
                $extension = $req->file('ngo_certificate_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $ngo_certificate = $req->file('ngo_certificate_file')->move(('uploads/ngo'), $filename);
            } else {
                $ngo_certificate = null;
            }

            if ($req->hasFile('fact_certificate_file')) {
                $extension = $req->file('fact_certificate_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $fact_certificate = $req->file('fact_certificate_file')->move(('uploads/ngo'), $filename);
            } else {
                $fact_certificate = null;
            }

            if ($req->hasFile('ngo_registor_certificate_file')) {
                $extension = $req->file('ngo_registor_certificate_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $ngo_registor_certificate = $req->file('ngo_registor_certificate_file')->move(('uploads/ngo'), $filename);
            } else {
                $ngo_registor_certificate = null;
            }

            if ($req->hasFile('g_reg80_file')) {
                $extension = $req->file('g_reg80_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $g_reg80 = $req->file('g_reg80_file')->move(('uploads/ngo'), $filename);
            } else {
                $g_reg80 = null;
            }

            if ($req->hasFile('relationship_certificate_file')) {
                $extension = $req->file('relationship_certificate_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $relationship_certificate = $req->file('relationship_certificate_file')->move(('uploads/ngo'), $filename);
            } else {
                $relationship_certificate = null;
            }

            if ($req->hasFile('fcra_file')) {
                $extension = $req->file('fcra_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $fcra = $req->file('fcra_file')->move(('uploads/ngo'), $filename);
            } else {
                $fcra = null;
            }

            if ($req->hasFile('ngo_achievement_file')) {
                $extension = $req->file('ngo_achievement_file')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $ngo_achievement = $req->file('ngo_achievement_file')->move(('uploads/ngo'), $filename);
            } else {
                $ngo_achievement = null;
            }

            if ($req->hasFile('direactor_aadhar')) {
                $extension = $req->file('direactor_aadhar')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $direactor_aadhar = $req->file('direactor_aadhar')->move(('uploads/ngo'), $filename);
            } else {
                $direactor_aadhar = null;
            }

            if ($req->hasFile('direactor_pan')) {
                $extension = $req->file('direactor_pan')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $direactor_pan = $req->file('direactor_pan')->move(('uploads/ngo'), $filename);
            } else {
                $direactor_pan = null;
            }
            if ($req->hasFile('direactor_photo')) {
                $extension = $req->file('direactor_photo')->extension();
                $filename = Str::random(4) . time() . '.' . $extension;
                $direactor_photo = $req->file('direactor_photo')->move(('uploads/ngo'), $filename);
            } else {
